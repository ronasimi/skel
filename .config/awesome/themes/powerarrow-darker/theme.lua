...
theme.layout_fullscreen             = themes_dir .. "/icons/max.png"
...
theme.layout_uselesstileleft        = themes_dir .. "/icons/uselesstileleft.png"
theme.layout_uselesstiletop         = themes_dir .. "/icons/uselesstiletop.png"
